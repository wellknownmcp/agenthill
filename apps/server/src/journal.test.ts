...
const facts: DebriefFacts = {
  ...
  places: [
    ...
    { slot: 2, outcome: "VACANT", peaceCount: 0, warCount: 0, burnedCents: 0, occupants: [], evicted: [], fromQueue: [] },
    {
      slot: 3,
      outcome: "PEACE",
      peaceCount: 1,
      ...
      occupants: [{ name: "Quiet Co", url: null, daysHeld: 2, pointsTonight: 8, rentTomorrowCents: 457, isNew: false }],
      evicted: [],
      fromQueue: [],
    },
  ],
  ...
  word: { kept: ["Quiet Co"], betrayed: ["Kettleworks"], bluffed: [], ghosted: [] },
  who: [
