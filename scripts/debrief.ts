...
const DEMO: DebriefFacts = {
  ...
  places: [
    {
      ...
      warCount: 2,
      burnedCents: 2600,
      occupants: [{ name: "Kettleworks", url: "https://kettleworks.example", daysHeld: 0, pointsTonight: 10, rentTomorrowCents: 345, isNew: true }],
    ...
    },
    {
      ...
      burnedCents: 0,
      occupants: [
        { name: "Northbeam", url: "https://northbeam.example", daysHeld: 3, pointsTonight: 4.5, rentTomorrowCents: 526, isNew: false },
        { name: "Aveline Studio", url: "https://aveline.example", daysHeld: 0, pointsTonight: 4.5, rentTomorrowCents: 345, isNew: true },
      ],
      evicted: [],
      fromQueue: [],
    },
    { slot: 3, outcome: "VACANT", peaceCount: 0, warCount: 0, burnedCents: 0, occupants: [], evicted: [], fromQueue: [] },
  ],
  totals: { placesOccupied: 2, placesVacant: 8, movesResolved: 6, peaceMoves: 4, warMoves: 2, burnedCents: 2600, spentCents: 3812, identitiesPlaying: 4 },
  context: {
    previousNight: { placesOccupied: 3, burnedCents: 800, movesResolved: 7 },
    burnedAvg7Cents: 1140,
  ...
  word: { kept: ["Aveline Studio"], betrayed: ["Kettleworks"], bluffed: [], ghosted: ["Corvid Labs"] },
  who: [
    {
      name: "Kettleworks",
